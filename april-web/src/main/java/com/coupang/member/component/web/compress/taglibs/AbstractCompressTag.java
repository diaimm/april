...
import com.coupang.member.component.web.compress.version.manager.CompressFileProvider;
 ...
 * @version $Rev$, $Date$
 */
public abstract class AbstractCompressTag extends SimpleTagSupport {
	private Logger logger = LoggerFactory.getLogger(AbstractCompressTag.class);
	protected String prefix = null;

	/**
	 * {@link CompressFileProvider}를 리턴한다.
	 * 
	 * @return {@link CompressFileProvider}
	 */
