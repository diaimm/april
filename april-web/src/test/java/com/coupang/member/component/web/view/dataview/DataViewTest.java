	...
	public void renderMergedOutputModelTest() {
		...
		try {
			...
			HttpServletResponseMock httpServletResponseMock = new HttpServletResponseMock() {
				/**
				 * @see com.coupang.member.component.web.view.dataview.DataViewTest.HttpServletResponseMock#setContentType(java.lang.String)
				 */
				@Override
				...
				/**
				 * @see com.coupang.member.component.web.view.dataview.DataViewTest.HttpServletResponseMock#getWriter()
				 */
				@Override
