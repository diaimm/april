...
import com.coupang.member.component.web.taglib.bufferedresponse.JavascriptCodeCollectorTag;
import com.coupang.member.component.web.taglib.bufferedresponse.JavascriptCodeCollectorTag.JSCodeCollectCommand;
import com.coupang.member.component.web.taglib.bufferedresponse.JavascriptCodeCollectorTag.ReadBodyContent;
...
public class JavascriptCodeCollectorTagTest {
	...
	private String getSampleHtmlCode() throws IOException {
		InputStream inputStream = getClassLoader().getResourceAsStream("com/coupang/member/component/web/taglib/bufferedresponse/JavascrtipCodeCollectorTagTestSampleCode.txt");
