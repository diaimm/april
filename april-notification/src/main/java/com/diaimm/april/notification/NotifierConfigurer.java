...
import com.diaimm.april.db.mybatis.support.MapperRegistrableConfigurer;
import com.diaimm.april.db.mybatis.support.MapperRegistrableConfigurer.MapperPosition;
...
public class NotifierConfigurer extends MapperRegistrableConfigurer {
	...
	/**
	 * @see com.diaimm.april.db.mybatis.support.MapperRegistrableConfigurer#afterMapperIntialized(org.springframework.beans.factory.config.ConfigurableListableBeanFactory, java.util.Map)
	 */
	@Override
	...
	/**
	 * @see com.diaimm.april.db.mybatis.support.MapperRegistrableConfigurer#getMapperTypes(java.lang.String)
	 */
	@Override
