...
public enum WellKnownFormats {
	...
	static class EmailFormatter implements Formatter {
		...
		/**
		 * @see com.coupang.member.commons.util.WellKnownFormats.Formatter#format(java.lang.Object[])
		 */
		@Override
		...
		/**
		 * @see com.coupang.member.commons.util.WellKnownFormats.Formatter#unformat(java.lang.String)
		 */
		@Override
