...
import com.coupang.member.commons.service.certification.ipin.IPIN;
import com.coupang.member.commons.service.certification.kmc.KMC;
...
public enum CertificationType {
	...
	KMC {
		...
		public CertifyData decoding(ByPhase byPhase, String encodedAuthData) {
			...
			KMC kMC = certificator.kmc().getKMCInfo(encodedAuthDatas[0], encodedAuthDatas[1]);
