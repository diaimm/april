 ...
 * 
 */
package com.coupang.member.commons.service.certification.ipin;
...
public class IPINClient {
	...
	enum MakeEncResultProcessor {
		...
		OK(0, "정상처리 되었습니다.") {
			/**
			 * @see com.coupang.member.commons.service.certification.ipin.IPINClient.MakeEncResultProcessor#process(int)
			 */
			@Override
