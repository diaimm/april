...
/**
 * Subclass of {@link org.springframework.orm.jpa.persistenceunit.MutablePersistenceUnitInfo} that adds instrumentation hooks based on
...
class SpringPersistenceUnitInfo extends MutablePersistenceUnitInfo {
	...
	public SharedCacheMode getSharedCacheMode() {
		return SharedCacheMode.valueOf(this.getSharedCacheModeName());
	}

	@Override
	public ValidationMode getValidationMode() {
		return ValidationMode.valueOf(this.getValidationModeName());
	}
	...
	public ClassLoader getNewTempClassLoader() {
		ClassLoader tcl = (this.loadTimeWeaver != null ? this.loadTimeWeaver.getThrowawayClassLoader() : new SimpleThrowawayClassLoader(
			this.classLoader));
