...
public class DBAccessBlockerClientConfigurer implements InitializingBean, BeanFactoryAware {
	...
	private static class DefaultDBAccessBlockerClient implements DBAccessBlockerClient {
		...
		/**
		 * @see com.coupang.member.db.mybatis.blocker.DBAccessBlockerClient#block(java.lang.String, org.apache.ibatis.mapping.SqlCommandType[])
		 */
		@Override
		...
		/**
		 * @see com.coupang.member.db.mybatis.blocker.DBAccessBlockerClient#release(java.lang.String, org.apache.ibatis.mapping.SqlCommandType[])
		 */
		@Override
