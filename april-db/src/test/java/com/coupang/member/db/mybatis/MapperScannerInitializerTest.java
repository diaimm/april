...
@ContextConfiguration(locations = "classpath:com/coupang/member/db/mybatis/SqlSessionTemplateInitializerTest.xml")
public class MapperScannerInitializerTest {
	...
	public void getDataSourceBeanConfigurationTest() {
		...
		try {
			...
			Assert.assertTrue(StringUtils.isNotEmpty(dataSourceBeanConfiguration));
